...
public class EnviarEmail {
    ...
    public EnviarEmail(String mail, String pass, String destino, String assunto, String msg) {
        meuEmail = mail;
        minhaSenha = pass;
    ...
    public EnviarEmail(String mail, String pass) {
        meuEmail = mail;
        minhaSenha = pass;
        emailDestinatario = "norttonsampaio_2012@hotmail.com";
        this.assunto = "Mensagem de Teste";
        this.msg = "Ta Funcionando, Birl! kkk";
    }
        ...
        Session s = Session.getDefaultInstance(props,
                new javax.mail.Authenticator() {
                    protected PasswordAuthentication getPasswordAuthentication() {
                        ...
                        return new PasswordAuthentication(meuEmail, minhaSenha);//email e senha usuário 
                    }
                });
